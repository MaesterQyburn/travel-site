...
var first = new _MobileMenu2.default();

var features = {
	select: (0, _jquery2.default)('.feature-item'),
	percent: "85%"
};

var test = {
	select: (0, _jquery2.default)('.testimonial'),
	percent: "80%"
};

var features = new _RevealOnScroll2.default(features.select, features.percent);
var testimonial = new _RevealOnScroll2.default(test.select, test.percent);
...
var RevealOnScroll = function () {
	function RevealOnScroll(selector, percent) {
...
var Modal = function () {
	...
	_createClass(Modal, [{
		key: 'events',
		value: function events() {
			//clicking open the modal button
